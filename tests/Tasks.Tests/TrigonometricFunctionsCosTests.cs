...
{
    public class TrigonometricFunctionsCosTests
    {
        public static IEnumerable<object[]> GetTestCases()
        {
            var solutions = new ITrigonometricFunctionsSolution[]
            {
                new Tasks.TrigonometricFunctions.TrigonometricFunctionsCos()
            };

            var testPoints = new ((double x, double e), double expected)[]
            {
                ((100, 0.0001), Math.Cos(100 * Math.PI / 180)),
                ((71, 0.0001), Math.Cos(71 * Math.PI / 180)),
                ((360, 0.0001), Math.Cos(360 * Math.PI / 180)),
                ((22, 0.0001), Math.Cos(22 * Math.PI / 180)),
                ((1111, 0.00001), Math.Cos(1111 * Math.PI / 180)),
            };
